...
<form class="flex flex-col items-center" method="post" action="register.php">
  ...
  <input type="submit" value="Register" class="px-4 rounded-r-lg bg-gray-800 text-white font-bold p-2 uppercase border-gray-800 border-t border-b border-r hover:bg-gray-700 focus:outline-none focus:bg-gray-700"/>
</form>
