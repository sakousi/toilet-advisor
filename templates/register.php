...
<form class="flex flex-col items-center py-10" method="post" action="register.php">
  <label for="username" class="text-gray-700 font-bold mb-2">Username:</label>
  <input type="text" id="name" name="name" class="w-3/4 px-4 py-2 rounded-lg border-t mr-0 border-b border-gray-200 text-gray-800 bg-white focus:outline-none focus:border-gray-500 border-l border-r" placeholder="Name" required>
