...
<form class="flex flex-col items-center py-10" method="post" action="/register">
  ...
  <label for="passwordConfirm" class="text-gray-700 font-bold mb-2">Confirm password:</label>
  <input type="password" id="passwordConfirm" name="passwordConfirm" class="w-3/4 px-4 py-2 rounded-lg border-t mr-0 border-b border-gray-200 text-gray-800 bg-white focus:outline-none focus:border-gray-500 border-l border-r" placeholder="Password" required>
  <input type="submit" value="Register" name="register" class="mt-4 px-4 rounded-lg bg-gray-800 text-white font-bold p-2 uppercase border-gray-800 border-t border-b border-r hover:bg-gray-700 focus:outline-none focus:bg-gray-700"/>
</form>
