...
<form class="flex flex-col items-center py-10" method="post" action="/login">
  ...
  <input type="submit" value="Login" name="login" class="mt-4 px-4 rounded-lg bg-gray-800 text-white font-bold p-2 uppercase border-gray-800 border-t border-b border-r hover:bg-gray-700 focus:outline-none focus:bg-gray-700"/>
</form>
